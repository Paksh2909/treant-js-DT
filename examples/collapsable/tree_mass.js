...
node0 = {text: {samples: '# Samples: 29', percentage: '% Samples: 100.0%', average: 'Average mass: 853.55', condition: 'Condition: method_Subtractive ?'}},
node1 = {parent: node0, text: {filter: 'Filter: method is not Subtractive', samples: 'Samples: 10', percentage: 'Percent: 34.48275862068966', average: 'Average: 292.1247299194336', condition: 'Condition: lead_time ?'}, folders: ['config_2_10', 'config_2_7', 'config_2_7', 'config_1_10', 'config_3_2', 'config_3_2', 'config_3_5', 'config_3_5', 'config_1_7', 'config_1_7']},
node2 = {parent: node1, text: {filter: 'Filter: lead_time <= 55585.5', samples: 'Samples: 8', percentage: 'Percent: 27.586206896551722', average: 'Average: 203.18336296081543', condition: 'Condition: lead_time ?'}, folders: ['config_2_10', 'config_2_7', 'config_2_7', 'config_1_10', 'config_3_5', 'config_3_5', 'config_1_7', 'config_1_7']},
node3 = {parent: node2, text: {filter: 'Filter: lead_time <= 33879.0', samples: 'Samples: 6', percentage: 'Percent: 20.689655172413794', average: 'Average: 162.97780100504556', condition: 'Condition: cost ?'}, folders: ['config_2_10', 'config_1_10', 'config_3_5', 'config_3_5', 'config_1_7', 'config_1_7']},
node4 = {parent: node3, text: {filter: 'Filter: cost <= 47450.0', samples: 'Samples: 4', percentage: 'Percent: 13.793103448275861', average: 'Average: 137.5851707458496', condition: 'Condition: compliance ?'}, folders: ['config_2_10', 'config_1_10', 'config_3_5', 'config_3_5']},
node5 = {parent: node4, text: {filter: 'Filter: compliance <= 0.0', samples: 'Samples: 3', percentage: 'Percent: 10.344827586206897', average: 'Average: nan', condition: 'Condition: cost ?'}, folders: []},
...
node12 = {parent: node0, text: {filter: 'Filter here: method is Subtractive', samples: 'Samples: 19', percentage: 'Percent: 65.51724137931035', average: 'Average: 1149.0357894736837', condition: 'Condition: cost ?'}, folders: ['config_2_5', 'config_2_2', 'config_2_3', 'config_2_4', 'config_1_5', 'config_1_2', 'config_3_1', 'config_1_3', 'config_1_4', 'config_2_1', 'config_2_6', 'config_2_8', 'config_2_9', 'config_1_1', 'config_1_6', 'config_1_8', 'config_1_9', 'config_3_4', 'config_3_3']},
node13 = {parent: node12, text: {filter: 'Filter: cost <= 76750.0', samples: 'Samples: 14', percentage: 'Percent: 48.275862068965516', average: 'Average: 961.9748571428572', condition: 'Condition: compliance ?'}, folders: ['config_2_5', 'config_2_2', 'config_2_4', 'config_1_5', 'config_1_2', 'config_3_1', 'config_1_4', 'config_2_1', 'config_2_8', 'config_1_1', 'config_1_6', 'config_1_8', 'config_3_4', 'config_3_3']},
...
node15 = {parent: node13, text: {filter: 'Filter here: compliance > 0.0', samples: 'Samples: 3', percentage: 'Percent: 10.344827586206897', average: 'Average: 961.9748571428572', condition: 'Condition: compliance ?'}, folders: ['config_2_5', 'config_2_2', 'config_2_4', 'config_1_5', 'config_1_2', 'config_3_1', 'config_1_4', 'config_2_1', 'config_2_8', 'config_1_1', 'config_1_6', 'config_1_8', 'config_3_4', 'config_3_3']},
...
node18 = {parent: node12, text: {filter: 'Filter here: cost > 76750.0', samples: 'Samples: 5', percentage: 'Percent: 17.24137931034483', average: 'Average: 1672.8064', condition: 'Condition: machine_type_2Axis ?'}, folders: ['config_2_3', 'config_1_3', 'config_2_6', 'config_2_9', 'config_1_9']},
...
node20 = {parent: node18, text: {filter: 'Filter here: machine_type is 2Axis', samples: 'Samples: 2', percentage: 'Percent: 6.896551724137931', average: 'Average: 1460.2240000000002', condition: 'Condition: lead_time ?'}, folders: ['config_2_9', 'config_1_9']},
